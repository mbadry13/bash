...
## Satellite registeration script was deliver to the customer.
## to generate a new script, Login to the satellite, from Content, Content View, Register a new client, and fill the needed fields.
# Paste the script generated from the satellite here
# run the below command to attach the Virtual Datacenter subscription
